...
@implementation AppDelegate
 ...
 - (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
 {
    ...
    self.recentView = [[RecentView alloc] initWithNibName:nil bundle:nil];
	self.groupsView = [[GroupsView alloc] initWithNibName:nil bundle:nil];
	self.peopleView = [[PeopleView alloc] initWithNibName:nil bundle:nil];
	self.settingsView = [[ProfileView alloc] initWithNibName:nil bundle:nil];
